//
//  MockAsyncThrowable.swift
//
//
//  Created by Nico Francken on 27/10/2024.
//

public struct MockAsyncThrowable<ArgumentType, ReturnType> {
    public typealias CallType = ((ArgumentType) async throws -> ReturnType)
    ...
    public mutating func record(_ arguments: ArgumentType) async throws -> ReturnType {
        ...
        return try await callMock(arguments)
    }
}
